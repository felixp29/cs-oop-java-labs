...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(student); // apeleaza toString() din clasa Student pt ca a fost overridden
        System.out.println(person); // apeleaza toString() din clasa Person pt ca a fost overridden
